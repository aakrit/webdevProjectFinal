...
class UserdetailsControllerTest < ActionController::TestCase
  ...
  test "should create userdetail" do
    assert_difference('Userdetail.count') do
      post :create, userdetail: { firstname: @userdetail.firstname, hobbies: @userdetail.hobbies, lastname: @userdetail.lastname, location: @userdetail.location, otherinfo: @userdetail.otherinfo }
    end
  ...
  test "should update userdetail" do
    put :update, id: @userdetail, userdetail: { firstname: @userdetail.firstname, hobbies: @userdetail.hobbies, lastname: @userdetail.lastname, location: @userdetail.location, otherinfo: @userdetail.otherinfo }
    assert_redirected_to userdetail_path(assigns(:userdetail))
  end
